...
const generateTask = (taskAttributes, id) => {
    ...
    if (newTask){
        ...
        (0,_store__WEBPACK_IMPORTED_MODULE_2__.storeData)([], [...newtaskList]);
    }
...
const initvalue = (id_dialog, id) => {
    ...
    const [lstProject, lstTask] = (0,_internal_store_js__WEBPACK_IMPORTED_MODULE_3__.extractData)();
    ...
    for (const task of taskList) {
        ...
        deleteButton.addEventListener("click", (e) => {
            ...
            if (newtaskList.length > 0){
                (0,_internal_store__WEBPACK_IMPORTED_MODULE_0__.storeData)([], newtaskList);
            }
            else {
                (0,_internal_store__WEBPACK_IMPORTED_MODULE_0__.resetData)(true, false);
            }
