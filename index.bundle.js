...
console.log("TEST")
;(0,_modules_ui_ui__WEBPACK_IMPORTED_MODULE_4__.callerForm)();

/***/ }),

/***/ "./src/modules/internal/createData.js":
/*!********************************************!*\
  !*** ./src/modules/internal/createData.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/modules/internal/editData.js":
/*!******************************************!*\
  !*** ./src/modules/internal/editData.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const generateTask = (taskAttributes, id) => {
    const taskValues = taskAttributes.map((elem) => elem.value);
    const taskList = (0,_store__WEBPACK_IMPORTED_MODULE_2__.extractData)()[1];
...
/***/ "./src/modules/ui/dialogCreate.js":
/*!****************************************!*\
  !*** ./src/modules/ui/dialogCreate.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _internal_createData_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../internal/createData.js */ "./src/modules/internal/createData.js");
...
const initDateStart = (id_dialog) => {
    ...
    const date1 = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(), 'yyyy-MM-dd');
...
function submitTask(event) {
    ...
    ;(0,_internal_createData_js__WEBPACK_IMPORTED_MODULE_0__.createTask)();
    form.close();
...
function submitProject(event) {
    ...
    event.preventDefault()
    ;(0,_internal_createData_js__WEBPACK_IMPORTED_MODULE_0__.createProject)();
    form.close();
...
/* harmony export */   "default": () => (/* binding */ openDialog)
/* harmony export */ });
/* harmony import */ var _internal_editData_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../internal/editData.js */ "./src/modules/internal/editData.js");
/* harmony import */ var _showTasks_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./showTasks.js */ "./src/modules/ui/showTasks.js");
/* harmony import */ var _showProjects_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./showProjects.js */ "./src/modules/ui/showProjects.js");
/* harmony import */ var _internal_store_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../internal/store.js */ "./src/modules/internal/store.js");
...
const submitTask = (event, id) => {
    ...
    event.preventDefault()
    ;(0,_internal_editData_js__WEBPACK_IMPORTED_MODULE_0__.editTask)(id);
    form.close();
    (0,_showTasks_js__WEBPACK_IMPORTED_MODULE_1__.showTasks)();
}
...
function submitProject(event, id) {
    ...
    event.preventDefault()
    ;(0,_internal_editData_js__WEBPACK_IMPORTED_MODULE_0__.editProject)(id);
    form.close();
    (0,_showProjects_js__WEBPACK_IMPORTED_MODULE_2__.showProjects)();
}
...
function openDialog(id_dialog, id) {
    const form = document.getElementById(id_dialog);
    form.showModal();
    initCancelButton(id_dialog);
...
/* harmony export */ });
/* harmony import */ var _internal_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../internal/store */ "./src/modules/internal/store.js");
/* harmony import */ var _dialogEdit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dialogEdit */ "./src/modules/ui/dialogEdit.js");
...
function showTasks() {
    ...
    for (const task of taskList) {
        ...
        editButton.addEventListener("click", (e) => {
            ;(0,_dialogEdit__WEBPACK_IMPORTED_MODULE_1__["default"])("edit-task", task.id);
        })
...
/* harmony export */ });
/* harmony import */ var _dialogCreate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dialogCreate.js */ "./src/modules/ui/dialogCreate.js");
...
function callerForm() {
    ...
    document.getElementById("add-task").addEventListener("click", (e) => {
        (0,_dialogCreate_js__WEBPACK_IMPORTED_MODULE_0__["default"])("form-task")
    });
    document.getElementById("add-project").addEventListener("click", (e) => {
        (0,_dialogCreate_js__WEBPACK_IMPORTED_MODULE_0__["default"])("form-project")
    });
