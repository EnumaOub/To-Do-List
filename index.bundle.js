...
/* harmony import */ var _modules_internal_task_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/internal/task.js */ "./src/modules/internal/task.js");
/* harmony import */ var _modules_internal_getInfo_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/internal/getInfo.js */ "./src/modules/internal/getInfo.js");
...
function insertTaskFromId(id, newTask) {
    ...
    if (index !== -1) {
        ...
        (0,_internal_store_js__WEBPACK_IMPORTED_MODULE_0__.storeData)([], [...newtaskList]);
        return true
    }
    else {
        return false
...
function insertProjectFromId(id, newProject) {
    const lstProject = (0,_internal_store_js__WEBPACK_IMPORTED_MODULE_0__.extractData)()[0];
    const index = getIndexProjectFromId(id);
    const newProjectList = lstProject.slice()
    if (index !== -1) {
        newProjectList[index] = newProject;
        (0,_internal_store_js__WEBPACK_IMPORTED_MODULE_0__.storeData)([...newProjectList], []);
        return true
    }
    else {
        return false
...
function deleteTaskFromId(id) {
    ...
    if (index !== -1) {
        ...
        if (newtaskList.length > 0){
            ...
            (0,_internal_store_js__WEBPACK_IMPORTED_MODULE_0__.resetData)(true, false);
        }
        return true;
    }
    else {
...
function deleteProjectFromId(id) {
    ...
    if (index !== -1) {
        ...
        if (newProjectList.length > 0){
            ...
            (0,_internal_store_js__WEBPACK_IMPORTED_MODULE_0__.resetData)(false, true);
        }
        return true;
    }
    else {
...
const modifyTask = (taskAttributes, id) => {
    ...
    if (newTask){
        ...
        (0,_internal_getInfo_js__WEBPACK_IMPORTED_MODULE_3__.insertTaskFromId)(id, newTask);
    }
}
...
const modifyProject = (projectAttributes, id) => {
    ...
    if (newProject){
        ...
        (0,_internal_getInfo_js__WEBPACK_IMPORTED_MODULE_3__.insertProjectFromId)(id, newProject);
    }
}
...
/* harmony import */ var _internal_getInfo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../internal/getInfo */ "./src/modules/internal/getInfo.js");
...
function showTasks() {
    ...
    for (const task of taskList) {
        ...
        deleteButton.addEventListener("click", (e) => {
            (0,_internal_getInfo__WEBPACK_IMPORTED_MODULE_2__.deleteTaskFromId)(task.getid());
