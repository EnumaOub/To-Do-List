...
select.priority-lst option[value="1"] {
    background: rgba(197, 209, 255, 1);
}

select.priority-lst option[value="2"] {
    background: rgba(107, 248, 107, 1);
}

select.priority-lst option[value="3"] {
...
(0,_modules_ui_ui__WEBPACK_IMPORTED_MODULE_5__.UI)().generate();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   autoPopulate: () => (/* binding */ autoPopulate)
/* harmony export */ });
...
/* harmony export */   taskGen: () => (/* binding */ taskGen)
/* harmony export */ });
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./store */ "./src/modules/internal/store.js");
/* harmony import */ var _internal_getInfo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../internal/getInfo.js */ "./src/modules/internal/getInfo.js");
...
function Dialog () {
    ...
    const submitTask = (event) => {
        ...
        ;(0,_internal_task_js__WEBPACK_IMPORTED_MODULE_0__.taskGen)().createTask();
        form.close();
        (0,_showTasks_js__WEBPACK_IMPORTED_MODULE_3__.taskUI)().showTasks();
    }
    
    const submitProject = (event) => {
        const form = document.getElementById("create-project");
        event.preventDefault()
        ;(0,_internal_project_js__WEBPACK_IMPORTED_MODULE_1__.projectGen)().createProject();
        form.close();
        (0,_showProjects_js__WEBPACK_IMPORTED_MODULE_2__.projectUI)().populateProjectTask();
        (0,_showProjects_js__WEBPACK_IMPORTED_MODULE_2__.projectUI)().showProjects();
    }
    ...
    const submitEditTask = (event, id, id_dialog) => {
        const form = document.getElementById(`${id_dialog}`);
        event.preventDefault()
        ;(0,_internal_task_js__WEBPACK_IMPORTED_MODULE_0__.taskGen)().editTask(id);
        form.close();
        (0,_showTasks_js__WEBPACK_IMPORTED_MODULE_3__.taskUI)().showTasks();
    ...
    const submitEditProject = (event, id, id_dialog) => {
        const form = document.getElementById(`${id_dialog}`);
        event.preventDefault()
        ;(0,_internal_project_js__WEBPACK_IMPORTED_MODULE_1__.projectGen)().editProject(id);
        form.close();
        (0,_showProjects_js__WEBPACK_IMPORTED_MODULE_2__.projectUI)().populateProjectTask();
        (0,_showProjects_js__WEBPACK_IMPORTED_MODULE_2__.projectUI)().showProjects();
        (0,_showTasks_js__WEBPACK_IMPORTED_MODULE_3__.taskUI)().showTasks();
...
function projectUI () {
    ...
    const generateCardProject = (project) => {
        ...
        deleteButton.addEventListener("click", (e) => {
            ...
            populateProjectTask();
            showProjects();
            (0,_showTasks__WEBPACK_IMPORTED_MODULE_2__.taskUI)().showTasks();
        })
    
        editButton.addEventListener("click", (e) => {
            ;(0,_dialog__WEBPACK_IMPORTED_MODULE_1__.Dialog)().openDialog("edit-project", project.getid());
...
function taskUI () {
    ...
    const generateCardTask = (task) => {
        ...
        editButton.addEventListener("click", (e) => {
            ;(0,_dialog__WEBPACK_IMPORTED_MODULE_1__.Dialog)().openDialog("edit-task", task.getid());
        })
...
function UI () {
    ...
    const addButton = () => {
        document.getElementById("add-task").addEventListener("click", (e) => {
            ...
            if (oldProjects.length > 0) {
                (0,_dialog_js__WEBPACK_IMPORTED_MODULE_0__.Dialog)().openDialog("create-task");
            }
        });
        document.getElementById("add-project").addEventListener("click", (e) => {
            (0,_dialog_js__WEBPACK_IMPORTED_MODULE_0__.Dialog)().openDialog("create-project")
        });
    };
    ...
    const showHideButton = () => {
        document.getElementById("btn-show-sb").addEventListener("click", (e) => {
            ...
            if (!(0,_showHide_js__WEBPACK_IMPORTED_MODULE_4__.showHide)().toggleShow("sidebar")) {
    ...
    const checkEmpty = () => {
        ...
        if(!(container.firstChild)){
            ...
            btn.addEventListener("click", function(event){
                (0,_internal_autoPop_js__WEBPACK_IMPORTED_MODULE_6__.autoPopulate)().autoPop();
                showAll();
            });
            div.appendChild(btn);
